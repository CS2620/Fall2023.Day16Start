...
def hsv_to_rgb(h,s,v):
  ...
  # Move anything above 5/6 into a negative vaule
  # if h  > 5/6:
  #   h = h - 1

  # Calculate the minimum value using saturation
  # n = (1-s)*v
  

  #Calculate how different the hue is from the 
  # three primary colors
  # diff_r = abs(h - 0 if h > 0 else h)
  # diff_g = abs(1/3 - h)
  # diff_b = abs(2/3 - h)

  # Calculate the r,g,b base on v,n and the hue
  ...
  # Move into [0,255] by flooring and rounding
